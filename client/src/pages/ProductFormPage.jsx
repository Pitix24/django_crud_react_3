        ...
        <form onSubmit={onSubmit}>
          ...
          >
            <option value="" disabled>
              {intl.formatMessage({
                id: "supplierid",
                defaultMessage: "Select Supplier ID",
              })}
            </option>
            {supplierIds.map((id) => (
          ...
          >
            <option value="" disabled>
              {intl.formatMessage({
                id: "categoryid",
                defaultMessage: "Select Category ID",
              })}
            </option>
            {categoryIds.map((id) => (
              <option key={id} value={id}>
          ...
          <input
            ...
            placeholder={intl.formatMessage({
              id: "quantityperunit",
              defaultMessage: "Quantity Per Unit",
            })}
          ...
          <input
            ...
            {...register("discontinued", { required: true })}
            className="bg-zinc-700 p-3 rounded-lg block w-full mb-3"
          />
          {errors.discontinued && (
            <span>
